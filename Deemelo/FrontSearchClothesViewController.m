//
//  FrontSearchClothesViewController.m
//  Deemelo
//
...
@implementation FrontSearchClothesViewController
...
- (void)loadCollection
{
    if (![self collection]) {
        ...
        [APIProvider getFrontSearchClothesPicturesFromSearchType:[self searchType]
                                                    searchString:[self searchString]
                                                        latitude:[[self searchLocation] coordinate].latitude
